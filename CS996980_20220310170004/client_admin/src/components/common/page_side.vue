<template>
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			,'/student/table'
			,'/courier/table'
			,'/courier_services_company/table'
			])">
			...
			<el-menu-item index="/courier/table" v-show="user_group == '管理员' || $check_action('/courier/table')"><span>快递员</span></el-menu-item>
			<el-menu-item index="/courier_services_company/table" v-show="user_group == '管理员' || $check_action('/courier_services_company/table')"><span>快递公司</span></el-menu-item>
			...
			auth() {
				...
				for (var i = 0; i < tables.length; i++) {
					...
					if (o.path.indexOf("/table") !== -1) {
						...
						list.push("student");
						list.push("courier");
						list.push("courier_services_company");
