						...
						<div class="card">
							...
							<div class="form_register">
								<b-form>
									...
									<!--快递员-->
									<form_courier v-if="form.user_group === '快递员'" :form="form_sub"></form_courier>
									<!--快递公司-->
									<form_courier_services_company v-if="form.user_group === '快递公司'" :form="form_sub"></form_courier_services_company>
...
<script>
	...
	/* 快递员 */
	import form_courier from "@/components/diy/form_courier";
	/* 快递公司 */
	import form_courier_services_company from "@/components/diy/form_courier_services_company";
