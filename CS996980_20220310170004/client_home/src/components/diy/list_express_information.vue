<template>
	<div class="diy_home diy_list diy_express_information" id="diy_express_information_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/express_information/details?express_information_id=' + o['express_information_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/express_information/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/express_information/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','student_account')">学生账号
					</th>
					...
					<th class="diy_title" v-if="$check_field('get','delivery_time')">配送时间
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_number" v-if="$check_field('get','express_quantity')">
						<span>
							{{ o["express_quantity"] }}
						</span>
					</td>
					...
					<td class="diy_field diy_uid" v-if="$check_field('get','student_account')">
						<span>
							{{ get_user_name(o['student_account']) }}
						</span>
					</td>
					<td class="diy_field diy_phone" v-if="$check_field('get','student_telephone')">
						<span>
							{{ o['student_telephone'] }}
						</span>
					</td>
					...
					<td class="diy_field diy_phone" v-if="$check_field('get','courier_telephone')">
						<span>
							{{ o['courier_telephone'] }}
						</span>
					</td>
					<td class="diy_field diy_datetime" v-if="$check_field('get','delivery_time')">
						<span>
							{{ $toTime(o["delivery_time"] ,"yyyy-MM-dd hh:mm:ss") }}
						</span>
					</td>
